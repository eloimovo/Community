package com.eloim.community.controller;

import com.eloim.community.entity.Comment;
import com.eloim.community.entity.DiscussPost;
import com.eloim.community.entity.Page;
import com.eloim.community.entity.User;
import com.eloim.community.service.*;
import com.eloim.community.util.CommunityConstant;
import com.eloim.community.util.CommunityUtil;
import com.eloim.community.util.HostHolder;
...
//        model.addAttribute("uploadToken", uploadToken);
    ...
    public String upload(MultipartFile file) {
        String url = null;
        try {
            url = oosService.uploadFile(file);

        } catch (IOException e) {
            e.printStackTrace();
            return CommunityUtil.getJSONString(1, "上传失败");
        }
        return CommunityUtil.getJSONString(0, url);
    }
    ...
    @ResponseBody
    public String updateHeaderUrl(String url) {
